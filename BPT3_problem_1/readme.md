Write a `script.sh` that reads a CSV file `student_data.csv` present in the current working directory containing student information with columns StudentID,Name,Age,Grade.
